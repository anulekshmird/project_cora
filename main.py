...
class CoraApp:
    def __init__(self):
        ...
        self.chat_win.closed_signal.connect(self.handle_chat_closed)
    ...
    def handle_chat_closed(self):
        """Called when chat window is closed or hidden."""
        print("Chat Window Closed/Hidden. Resuming Observer.")
        self.is_chat_active = False
