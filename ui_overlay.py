...
class ProactiveBubble(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.bubble_size = 70
        self.panel_width = 320 # Increased slightly
        self.panel_height = 240 # Default
        self.panel_expanded_height = 340 # When "Read more" is clicked
        self.margin = 20
        ...
        # Read More Button (Subtle Link Style)
    ...
    def update_layout_pos(self):
        ...
        current_panel_h = self.panel_expanded_height if self.is_read_more_expanded else self.panel_height
    ...
    def _show_suggestion_inner(self, data):
        ...
        self.is_read_more_expanded = False # Reset expansion state on new suggestion
    ...
    def toggle_expand(self):
        ...
        if self.is_expanded:
            ...
            self.panel.hide()
            self.is_read_more_expanded = False # Collapse read more too
    ...
    def toggle_read_more(self):
        ...
        if self.is_read_more_expanded:
            full_text = f"{self.current_data.get('reason', '')}\n\n{self.current_data.get('reason_long', '')}"
